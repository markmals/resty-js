...
export class RequestBuilder {
    ...
    public constructor(method: Method, private url: URL) {
    ...
    public expectedStatusCode(range: Range) {
        this.statusCode = range;
    }

    /** Adds the search parameter to the request. */
    public searchParam(key: string, value: string) {
        this.url.searchParams.set(key, value);
    }

    /** Adds the search parameters to the request. */
    public searchParams(query: URLSearchParams) {
...
export abstract class API {
    ...
    private buildRequestBuilder(method: Method, path: string) {
